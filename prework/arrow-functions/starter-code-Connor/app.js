...
// let theOldWay = course => `I am currently enrolled in ${course}`;
...
//attempt to make arrow function work with refactoring
...
let courseName = () => 'This student is enrolled in Code 301.';
...
//"this" was referring to the previous constuctor's parameters but wouldn't be invoked due to scope has not return within the prototype function.
// 2. What is "this" when joe.scopeArrow() is invoked?
//"this" in this instance refers to the entirety of the constuctor function. This is only an educated guess though.
// 3. Explain why "this" is different when an arrow function is used.
//I'm assuming this is beacause when using an arrow function it is always used for a specific line of code, but whne used with the "this" term it will use the enitre constructor to show up in console.
